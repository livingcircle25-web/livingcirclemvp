...
const styles = StyleSheet.create({
  ...
  // Benefits
  benefitsCard: {
    backgroundColor: "rgba(24,144,255,0.06)", borderRadius: R.lg,
    borderWidth: 1, borderColor: "rgba(24,144,255,0.35)", padding: 18, gap: 10,
  },
  ...
  primaryBtn: {
    ...
    borderRadius: R.pill,
    shadowColor: C.coral, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.18, shadowRadius: 10,
    elevation: 8,
  },
  ...
  resultVerified: { backgroundColor: "rgba(82,196,26,0.1)", borderColor: C.success },
  resultPending:  { backgroundColor: "rgba(250,173,20,0.1)",  borderColor: C.warning },
  resultError:    { backgroundColor: "rgba(255,77,79,0.1)",  borderColor: C.error },
  ...
  submitBtn: {
    ...
    borderWidth: 2, borderColor: C.borderCyan,
    shadowColor: C.coral, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.20, shadowRadius: 14,
    elevation: 10,
  },
  ...
  privacyCard: {
    ...
    backgroundColor: "rgba(24,144,255,0.06)", borderRadius: R.lg,
    borderWidth: 1, borderColor: "rgba(24,144,255,0.25)", padding: 16,
  },
