            ...
            <Animated.View entering={FadeInDown.delay(index * 60).springify()} style={[styles.card, CARD_SHADOW]}>
              ...
              {!item.can_chat && (
                <View style={styles.verifyBadge}>
                  ...
                  <Text style={styles.verifyBadgeText}>
                    {item.my_verified ? "Waiting for them to verify" : "Verification pending"}
                  </Text>
                </View>
              )}
              ...
              <View style={styles.actions}>
                ...
                <PressableScale
                  ...
                  onPress={() =>
                    item.can_chat
                      ? router.push({ pathname: "/chat/[id]", params: { id: item.match_id, name: item.user.name } })
                      : router.push({ pathname: "/verification/[matchId]", params: { matchId: item.match_id } })
                  }
                  style={[styles.actionBtn, styles.chatBtn]}
                >
                  <Ionicons name={item.can_chat ? "chatbubble" : "lock-closed"} size={14} color={C.onBrand} />
                  <Text style={styles.chatBtnText}>{item.can_chat ? "Chat" : "Verify"}</Text>
                </PressableScale>
              </View>
            </Animated.View>
          )}
...
const styles = StyleSheet.create({
  ...
  xBtn: {
    ...
    backgroundColor: "rgba(24,144,255,0.10)", alignItems: "center", justifyContent: "center",
    borderWidth: 1, borderColor: C.borderCoral, zIndex: 5,
  },
  name: { fontSize: 18, fontWeight: "800", color: C.onSurface, marginTop: S.sm, letterSpacing: 0.3 },
  ...
  verifyBadge: {
    ...
    backgroundColor: "rgba(250,173,20,0.10)", borderWidth: 1, borderColor: C.warning,
    borderRadius: R.pill, paddingHorizontal: S.md, paddingVertical: 3, marginTop: 2,
  },
  verifyBadgeText: { color: C.warning, fontSize: 11, fontWeight: "700" },
  sharedChips: {
  ...
  lifestyleTileValue: { fontSize: 14, color: C.onSurface, fontWeight: "600" },
  ...
  viewBtn: { borderColor: C.borderCyan, backgroundColor: "rgba(24,144,255,0.06)" },
  viewBtnText: { color: C.cyan, fontWeight: "700", fontSize: 13 },
  mapBtn: { borderColor: "rgba(168,85,247,0.4)", backgroundColor: "rgba(168,85,247,0.10)" },
  mapBtnText: { color: "#8B5CF6", fontWeight: "700", fontSize: 13 },
  chatBtn: { borderColor: C.coral, backgroundColor: C.coral },
  ...
  pmName: { fontSize: 24, fontWeight: "900", color: C.onSurface, marginTop: S.md, letterSpacing: 0.3 },
  pmMeta: { fontSize: 14, color: C.onSurfaceSecondary, marginTop: 2 },
  pmCompat: {
    flexDirection: "row", alignItems: "center", gap: 4,
    backgroundColor: "rgba(24,144,255,0.10)", paddingHorizontal: S.md, paddingVertical: 4,
  ...
  rowIcon: { width: 32, height: 32, borderRadius: R.sm, backgroundColor: "rgba(24,144,255,0.08)", alignItems: "center", justifyContent: "center" },
