...
const styles = StyleSheet.create({
  ...
  topBrand: { fontSize: 18, fontWeight: "800", color: C.onSurface, letterSpacing: -0.3 },
  ...
  name: { fontSize: 24, fontWeight: "800", color: C.onSurface, letterSpacing: -0.4 },
  ...
  verifiedPill: {
    ...
    backgroundColor: "rgba(82,196,26,0.15)", borderRadius: 12,
  ...
  getVerifiedBtn: {
    ...
    backgroundColor: "rgba(24,144,255,0.08)", borderRadius: R.lg,
  ...
  verifiedBanner: {
    flexDirection: "row", alignItems: "center", gap: 10,
    marginHorizontal: S.xl, marginTop: S.lg,
    backgroundColor: "rgba(82,196,26,0.10)", borderRadius: R.lg,
  ...
  sectionTitle: { fontSize: 12, color: C.brand, fontWeight: "800", textTransform: "uppercase", letterSpacing: 1.4, marginBottom: S.md },
  row: { flexDirection: "row", alignItems: "center", paddingVertical: S.sm, gap: S.md },
  rowIcon: {
    width: 32, height: 32, borderRadius: R.sm,
    backgroundColor: "rgba(24,144,255,0.08)", alignItems: "center", justifyContent: "center",
  ...
  safetyBtn: {
    ...
    borderWidth: 1, borderColor: C.borderCoral, backgroundColor: "rgba(24,144,255,0.06)",
  },
