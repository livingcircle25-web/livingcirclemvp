...
function Card({
  ...
  // Discover cards never show photos, by design — the backend already omits
  // `photo` for this endpoint, but we also never pass it into <Avatar> here
          ...
          <View style={styles.info}>
            <View style={styles.headerRow}>
              <View style={styles.avatarRing}>
                <Avatar name={p.name} photo={null} size={48} />
              </View>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={["top"]}>
        ...
        <View style={styles.bannerPrimary}>
          ...
          <Text style={styles.bannerPrimaryText}>
            India&apos;s #1 roommate finder — verified &amp; private
          </Text>
        </View>
        ...
        <View style={styles.deck}>
          {loading ? (
            ...
            <View style={styles.emptyWrap} testID="discover-empty">
              ...
              <Text style={styles.emptySub}>Try widening your filters.</Text>
              <PressableScale
        ...
        {remaining.length > 0 && !loading && (
          <View style={styles.actions}>
            ...
            <PressableScale
              testID="like-button"
              style={[styles.actionBtn, GLOW_CYAN, { borderColor: C.cyan, backgroundColor: "rgba(24,144,255,0.10)" }]}
...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 18, fontWeight: "800", color: C.onSurface, letterSpacing: -0.3 },
  filterBtn: {
  ...
  bannerPrimary: {
    ...
    borderRadius: R.pill, paddingVertical: 8, paddingHorizontal: S.md,
    borderWidth: 1, borderColor: "rgba(0,212,180,0.25)",
  },
  bannerPrimaryText: { fontSize: 12.5, color: C.brand, fontWeight: "700", letterSpacing: 0.3 },
  ...
  photosLockedBanner: {
    ...
    backgroundColor: "rgba(24,144,255,0.90)",
  ...
  compatBadge: {
    ...
    borderWidth: 1.5, borderColor: C.borderCoral,
  },
  compatBadgeNum: { color: C.coral, fontWeight: "900", fontSize: 14 },
  compatBadgeLabel: { color: C.onSurface, fontWeight: "600", fontSize: 11, opacity: 0.9 },
  stamp: {
  ...
  tag: { backgroundColor: "rgba(24,144,255,0.90)", paddingHorizontal: S.md, paddingVertical: 4, borderRadius: R.pill },
  tagText: { color: "#FFFFFF", fontWeight: "700", fontSize: 11 },
  metaBlock: { gap: 2 },
  meta: { color: "#FFFFFF", fontSize: 13, lineHeight: 18 },
  metaMuted: { color: "rgba(255,255,255,0.75)", fontSize: 12, lineHeight: 16 },
  lifestyleRow: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: S.sm },
  pill: {
    backgroundColor: "rgba(255,255,255,0.18)", paddingHorizontal: S.md, paddingVertical: 5,
    borderRadius: R.pill, borderWidth: 1, borderColor: "rgba(255,255,255,0.35)",
  },
  pillText: { color: "#FFFFFF", fontSize: 12, fontWeight: "600" },
  bio: { color: "rgba(255,255,255,0.9)", fontSize: 13, lineHeight: 19, fontStyle: "italic" },
  actions: { flexDirection: "row", justifyContent: "center", gap: S.xxl, paddingBottom: S.lg, paddingTop: S.sm },
  actionBtn: {
    width: 68, height: 68, borderRadius: 34, backgroundColor: C.surface,
  ...
  refreshBtn: { marginTop: S.xl, backgroundColor: C.coral, paddingHorizontal: S.xl, paddingVertical: S.md, borderRadius: R.pill },
  ...
  cta: { backgroundColor: C.coral, paddingVertical: S.lg, borderRadius: R.pill, alignItems: "center" },
  ...
  botFabText: { color: C.cyan, fontWeight: "800", fontSize: 13, letterSpacing: 0.3 },
});
