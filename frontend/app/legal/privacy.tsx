...
const styles = StyleSheet.create({
  ...
  noticeBanner: {
    ...
    backgroundColor: "rgba(82,196,26,0.08)", borderRadius: R.md, padding: S.md,
    borderWidth: 1, borderColor: "rgba(82,196,26,0.3)", marginBottom: S.lg,
  },
  noticeText: { flex: 1, fontSize: 13, color: "#237804", lineHeight: 18 },
  section: {
