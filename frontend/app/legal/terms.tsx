...
const styles = StyleSheet.create({
  ...
  noticeBanner: {
    ...
    backgroundColor: "rgba(24,144,255,0.08)", borderRadius: R.md, padding: S.md,
    borderWidth: 1, borderColor: "rgba(24,144,255,0.3)", marginBottom: S.lg,
  },
  noticeText: { flex: 1, fontSize: 13, color: C.onSurface, lineHeight: 18 },
  section: {
