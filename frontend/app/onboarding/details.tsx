...
export default function Details() {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.label}>Preferred Localities <Text style={styles.req}>*</Text></Text>
      ...
      <View style={styles.geocodeRow}>
        ...
        {workLat && <Ionicons name="checkmark-circle" size={20} color={C.success} style={{ marginLeft: 8 }} />}
      </View>
...
const styles = StyleSheet.create({
  ...
  homePill: {
    ...
    backgroundColor: "rgba(24,144,255,0.1)", borderRadius: R.pill,
  ...
  selectedChip: {
    ...
    backgroundColor: "rgba(24,144,255,0.12)", borderRadius: R.pill,
  ...
  workConfirmed: {
    marginTop: 6, backgroundColor: "rgba(82,196,26,0.08)", borderRadius: R.md,
    padding: 8, borderWidth: 1, borderColor: "rgba(82,196,26,0.3)",
  },
  workConfirmedText: { color: C.success, fontSize: 12, fontWeight: "600" },
});
...
const pm = StyleSheet.create({
  ...
  itemSelected: { backgroundColor: "rgba(24,144,255,0.08)" },
  ...
  doneBtnText: { color: C.onSurface, fontWeight: "800", fontSize: 15 },
});
